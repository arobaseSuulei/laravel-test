...
<div class="">
    <div onclick="ouvrirModal()" class="sm:hidden hover:bg-black hover:text-white border p-2 flex justify-center rounded-3xl mx-16 my-4 cursor-pointer">
        Reserver avec l' IA
    </div>
...
<div class="flex flex-col gap-2 fixed sm:static bottom-0 left-0 w-full">
    ...
    <div class=" hidden sm:flex justify-center mt-2">
        ...
        <nav class="flex border rounded-2xl gap-4 p-4 items-center w-fit">
            ...
            <div onclick="ouvrirModal()" class="hidden hover:bg-black hover:text-white border p-2 sm:flex justify-center rounded-3xl  cursor-pointer">
                Reserver avec l' IA
            </div>
